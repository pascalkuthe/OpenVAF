...
use openvaf_hir::functions::{Function, HirFunction};
use openvaf_hir::{
...
impl VerilogAState {
    pub fn new_compiletime_const() -> Self {
        Self {
            allowed: AllowedOperations::empty(),
            location: AccessLocation::Constants,
        }
    }

    pub fn new_runtime_const() -> Self {
        Self {
            allowed: ALLOWED_OPS_CONST_EXPRESSION,
            location: AccessLocation::Constants,
        }
    }
    ...
    pub fn new_attribute(allowed: AllowedOperations) -> Self {
        Self {
            allowed,
            location: AccessLocation::Attribute,
        }
    }
    ...
    pub fn enter_function_decl(&mut self) -> Self {
        self.enter(
            ALLOWED_OPS_ANALOG_FUNCTION_BEHAVIOUR,
            AccessLocation::AnalogFunction,
        )
    }
