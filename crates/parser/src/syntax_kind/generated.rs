...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ...
            | PARAMETER_KW | REAL_KW | STRING_KW | WHILE_KW | ROOT_KW => true,
            _ => false,
        }
    }
    ...
    pub fn is_literal(self) -> bool {
        match self {
            INT_NUMBER | STD_REAL_NUMBER | SI_REAL_NUMBER | STRING => true,
            _ => false,
        }
    }
