...
pub use ast::{BinaryOperator, Type};
...
pub use ast::ConstVal;
use ir::ids::{CallArg, NodeId};
use ir::DisciplineAccess;
pub use middle::{Discipline, Node, Port};
...
impl Variable {
    pub const PLACEHOLDER: Self =
        Self { ident: Ident::DUMMY, ty: Type::INT, default: None, sctx: SyntaxCtx::ROOT };
}
