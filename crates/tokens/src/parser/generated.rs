...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ...
            | PARAMETER_KW | REAL_KW | STRING_KW | WHILE_KW | ROOT_KW | INITIAL_STEP_KW
            | FINAL_STEP_KW => true,
            _ => false,
        }
    }
