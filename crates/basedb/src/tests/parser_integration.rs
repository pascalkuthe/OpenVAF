...
fn amplifier() {
    ...
    let db = TestDataBase::new("/amplifier.va", Default::default());
...
fn asmhemt() {
    ...
    let db = TestDataBase::new("/asmhemt.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn bsim3() {
    ...
    let db = TestDataBase::new("/bsim3.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn bsim4() {
    ...
    let db = TestDataBase::new("/bsim4.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn bsim6() {
    ...
    let db = TestDataBase::new("/bsim6.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn bsimbulk() {
    ...
    let db = TestDataBase::new("/bsimbulk.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn bsimcmg() {
    ...
    let db = TestDataBase::new("/bsimcmg.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn bsimimg() {
    ...
    let db = TestDataBase::new("/bsimimg.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn bsimsoi() {
    ...
    let db = TestDataBase::new("/bsimsoi.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn cccs() {
    ...
    let db = TestDataBase::new("/cccs.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn current_source() {
    ...
    let db = TestDataBase::new("/current_source.va", Default::default());
    let mut vfs = db.vfs().write();
    let path =
...
fn diode() {
    ...
    let db = TestDataBase::new("/diode.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn diode_cmc() {
    ...
    let db = TestDataBase::new("/diode_cmc.va", Default::default());
    let mut vfs = db.vfs().write();
    let path = project_root()
        .join("integration_tests")
        .join("DIODE_CMC")
...
fn ekv() {
    ...
    let db = TestDataBase::new("/ekv.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn ekv_longchannel() {
    ...
    let db = TestDataBase::new("/ekv_longchannel.va", Default::default());
    let mut vfs = db.vfs().write();
    let path =
...
fn hicuml2() {
    ...
    let db = TestDataBase::new("/hicuml2.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn hisim2() {
    ...
    let db = TestDataBase::new("/hisim2.va", Default::default());
    let mut vfs = db.vfs().write();
    let path =
...
fn hisimhv() {
    ...
    let db = TestDataBase::new("/hisimhv.va", Default::default());
    let mut vfs = db.vfs().write();
    let path =
...
fn hisimsotb() {
    ...
    let db = TestDataBase::new("/hisimsotb.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn mextram() {
    ...
    let db = TestDataBase::new("/mextram.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn mvsg_cmc() {
    ...
    let db = TestDataBase::new("/mvsg_cmc.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn psp102() {
    ...
    let db = TestDataBase::new("/psp102.va", Default::default());
    let mut vfs = db.vfs().write();
    let path =
...
fn psp103() {
    ...
    let db = TestDataBase::new("/psp103.va", Default::default());
    let mut vfs = db.vfs().write();
    let path =
...
fn resistor() {
    ...
    let db = TestDataBase::new("/resistor.va", Default::default());
    let mut vfs = db.vfs().write();
...
fn vccs() {
    ...
    let db = TestDataBase::new("/vccs.va", Default::default());
    let mut vfs = db.vfs().write();
