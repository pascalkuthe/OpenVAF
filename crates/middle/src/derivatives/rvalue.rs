    ...
    for RValueAutoDiff<'lt, 'adlt, C, MC>
{
    ...
    fn fold_bit_negate(&mut self, op: Span, _arg: &COperand<C>) -> Self::T {
        self.ad.errors.add(DerivativeNotDefined(UndefinedDerivative::BitWiseOp, op));
        None
    }
    ...
    fn fold_logic_negate(&mut self, op: Span, _arg: &COperand<C>) -> Self::T {
        self.ad.errors.add(DerivativeNotDefined(UndefinedDerivative::LogicOp, op));
        None
    }
    ...
    fn fold_real_rem(&mut self, op: Span, _lhs: &COperand<C>, _rhs: &COperand<C>) -> Self::T {
        self.ad.errors.add(DerivativeNotDefined(UndefinedDerivative::Modulus, op));
        None
    }
    ...
    fn fold_shiftl(&mut self, op: Span, lhs: &COperand<C>, rhs: &COperand<C>) -> Self::T {
        ...
        match (dlhs, drhs) {
            ...
            (Some(dlhs), Some(drhs)) => {
                ...
                Some(RValue::BinaryOperation(Spanned::new(Multiply, op), dlhs, drhs))
            }
        }
    }
    ...
    fn fold_lt_real(&mut self, op: Span, _lhs: &COperand<C>, _rhs: &COperand<C>) -> Self::T {
        self.ad.errors.add(DerivativeNotDefined(UndefinedDerivative::Comparison, op));
        None
    }
    ...
    fn fold_exp(&mut self, span: Span, arg: &COperand<C>, _limit: bool) -> Self::T {
        ...
        Some(RValue::BinaryOperation(Spanned::new(Multiply, span), arg_derivative, original))
    }
    ...
    fn fold_ln(&mut self, span: Span, arg: &COperand<C>) -> Self::T {
        ...
        Some(RValue::BinaryOperation(Spanned::new(Divide, span), arg_derivative, arg.clone()))
    }
    ...
    fn fold_clog2(&mut self, span: Span, _arg: &COperand<C>) -> Self::T {
        Linter::dispatch_late(Box::new(RoundingDerivativeNotFullyDefined(span)), self.origin);
        None
    }
    ...
    fn fold_asin(&mut self, span: Span, arg: &COperand<C>) -> Self::T {
        ...
        // f'/sqrt(1-f²)
        Some(RValue::BinaryOperation(Spanned::new(Divide, span), arg_derivative, den))
    }
    ...
    fn fold_acos(&mut self, span: Span, arg: &COperand<C>) -> Self::T {
        ...
        Some(RValue::UnaryOperation(Spanned::new(ArithmeticNegate, span), dasin))
    }
    ...
    fn fold_pow(&mut self, span: Span, lhs: &COperand<C>, rhs: &COperand<C>) -> Self::T {
        ...
        Some(RValue::BinaryOperation(Spanned::new(Multiply, span), sum, original))
    }
    ...
    fn fold_hypot(&mut self, span: Span, arg1: &COperand<C>, arg2: &COperand<C>) -> Self::T {
        ...
        Some(RValue::BinaryOperation(Spanned::new(Divide, span), num, original))
    }
    ...
    fn fold_atan2(&mut self, span: Span, arg1: &COperand<C>, arg2: &COperand<C>) -> Self::T {
        ...
        Some(RValue::BinaryOperation(Spanned::new(Divide, span), num, den))
    }
...
impl<'lt, 'adlt, C: CfgFunctions, MC: CfgFunctions> RValueAutoDiff<'lt, 'adlt, C, MC> {
    ...
    pub fn derivative_sum(
        ...
        match (lhs_derivative.contents.into_option(), rhs_derivative.contents.into_option()) {
            (None, None) => None,
            ...
            (Some(lhs), Some(rhs)) => {
                let lhs = Operand::new(lhs, lhs_derivative.span);
                let rhs = Operand::new(rhs, rhs_derivative.span);
                Some(RValue::BinaryOperation(Spanned::new(BinOp::Plus, span), lhs, rhs))
            }
        }
    }
    ...
    pub fn derivative_sub(
        ...
        match (lhs_derivative.contents.into_option(), rhs_derivative.contents.into_option()) {
            ...
            (Some(lhs), Some(rhs)) => {
                let lhs = Operand::new(lhs, lhs_derivative.span);
                let rhs = Operand::new(rhs, rhs_derivative.span);
                Some(RValue::BinaryOperation(Spanned::new(BinOp::Minus, span), lhs, rhs))
            }
        }
    }
    ...
    fn derivative_mul(
        ...
        Self::derivative_sum(Spanned::new(sum1, lhs.span), Spanned::new(sum2, rhs.span), span)
    }
    ...
    fn derivative_div(
        ...
        Self::derivative_sub(Spanned::new(sum1, lhs.span), Spanned::new(sum2, rhs.span), span)
    }
    ...
    fn chain_rule_with_known_derivative(
        ...
        match derivative {
            ...
            Derivative::Operand(inner) => {
                ...
                Some(RValue::BinaryOperation(Spanned::new(BinOp::Multiply, span), inner, outer))
            }
        }
    }
    ...
    pub fn derivative(&mut self, operand: &COperand<C>) -> CallTypeDerivative<C> {
        ...
        self.ad.cfg.demand_operand_derivative_unchecked(self.ad.mir, operand, self.unknown)
    }
}
