...
use crate::dfa_framework::graph::Graph;
...
/// [Reverse postorder](openvaf_mir::cfg::transversal::ReversePostorder) DFA [direction](Direction)
pub struct Forward;
...
/// [Postorder](openvaf_mir::cfg::transversal::Postorder) DFA [direction](Direction)
pub struct Backward;
