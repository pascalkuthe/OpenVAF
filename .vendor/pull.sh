#!/usr/bin/env bash 
if s3cmd get s3://openva/vendor-239dyhmf5oqjy4kwvzzpc5v4c.tar.zst vendor-239dyhmf5oqjy4kwvzzpc5v4c.tar.zst; then
    tar --zstd -xf "vendor-239dyhmf5oqjy4kwvzzpc5v4c.tar.zst"
    found=1
fi
